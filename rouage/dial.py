...
/* No landscape gate. One was built and removed: it read as an obstacle
   rather than a courtesy, and a reader who has opened a technical drawing on a
   phone has already decided they want to look at it on a phone. What actually
   made the dial usable there is below - the plate holds a legible size and
   pans, instead of shrinking until its engravings are unreadable. That was
   always the real fix; the gate was the part in the way. */
